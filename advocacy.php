...
<main role="main">
  ...
  <section class="page-content">
    ...
    <div class="advocacy-news-page-content-container">
      ...
      <!-- Template markup for larger screen sizes (roughly laptop and desktop size) -->
      <!-- Sidebar -->
      <aside class="categories-take-action-sidebar sidebar-advocacy">
        <ul class="categories-list">
          ...
          <!-- Get list of categories for custom post type, Advocacy Items -->
          <?php $args = array(
            'show_option_all'    => '',
            'orderby'            => 'count',
            'order'              => 'ASC',
      ...
      <div class="advocacy-news-content">
        ...
        <!-- Setup and display pagination links -->
      ...
      <!-- Template markup for smaller screen sizes (roughly tablet and smaller) -->
      <div class="advocacy-news-content mobile">
        
        <!-- Mobile Content Nav (dropdown menu)-->  
        <div class="mobile-content-nav current-page">
          ...
          <ul id="subpage-list">
            <!-- Get list of Advocacy Categories -->
            <?php $args = array(
              'show_option_all'    => '',
              'orderby'            => 'count',
              'order'              => 'ASC',
        ...
        <!-- Mobile Take Action dropdown navigation following the article -->
